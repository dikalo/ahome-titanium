...
public class UiBinderWriter implements Statements {
	...
	private static String capitalizePropName(String propName) {
		return StringCase.toUpper(propName.substring(0, 1))
	...
	public UiBinderWriter(JClassType baseClass, String implClassName,
			...
			String binderUri, ResourceOracle resourceOracle)
	...
	public JClassType findFieldType(XMLElement elem)
		...
		while (true) {
			JClassType rtn = getOracle()
					.findType(packageName + "." + className);
			if (rtn != null) {
				return rtn;
			}
	...
	public boolean isViewElement(XMLElement elem)
			throws UnableToCompleteException {
	...
	private void registerParsers() {
		...
		addAitParser("titanium", "HasWidgets");
	}
	...
	private void addAitParser(String library, String className) {
		String gwtClass = "com.ait.toolkit." + library
				+ ".mobile.client.ui.interfaces." + className;
