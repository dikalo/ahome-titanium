...
public class History {
	...
	private static class HistoryEventSource implements
	...
	private static class HistoryImpl {
		...
		// Only kept in deferred binding to allow mocking frameworks to
		// intercept calls
	...
	private static class WrapHistory extends
			BaseListenerWrapper<HistoryListener> implements
