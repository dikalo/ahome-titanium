...
public final class Impl {
    ...
    private static UnloadSupport unloadSupport = GWT.isScript() ? (UnloadSupport) GWT.create(UnloadSupport.class)
                    : new UnloadSupport();
    ...
    public static void reportUncaughtException(Throwable e) {
        ...
        // Make sure that the exception is not swallowed and let the browser
        // handle it
        reportToBrowser(e);
    }
    ...
    private static native Object apply(Object jsFunction, Object thisObj, Object args) /*-{
		if (@com.google.gwt.core.client.GWT::isScript()()) {
