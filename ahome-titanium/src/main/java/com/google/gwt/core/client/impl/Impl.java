...
public final class Impl {
    ...
    public static native JavaScriptObject entry( JavaScriptObject jsFunction ) /*-{
		return function() {
			if (@com.google.gwt.core.client.GWT::isScript()()) {
				return @com.google.gwt.core.client.impl.Impl::entry0(*)(jsFunction, this, arguments);
			} else {
				var _ = @com.google.gwt.core.client.impl.Impl::entry0(*)(jsFunction, this, arguments);
				if (_ != null) {
    ...
    private static void reportToBrowser( Throwable e ) {
        if( TiUtils.isWebMode() ) {
            reportToBrowser( e instanceof JavaScriptException ? ( (JavaScriptException) e )
                .getThrown() : e );
        } else {
            reportToBrowserForTi( e instanceof JavaScriptException ? ( (JavaScriptException) e )
                .getThrown() : e );
        }
    ...
    private static native void reportToBrowserForTi( Object e ) /*-{
		setTimeout(function() {
			throw e;
		}, 0);
    }-*/;
    ...
    public static native JavaScriptObject registerEntry() /*-{
															...
															return @com.google.gwt.core.client.impl.Impl::entry(*);
															} else {
															// But we have to do in in Development Mode
															return $entry = @com.google.gwt.core.client.impl.Impl::entry(*);
															}
															}-*/;
        ...
        if( GWT.isScript() && entryDepth != 0 ) {
            ...
            if( now - watchdogEntryDepthLastScheduled > WATCHDOG_ENTRY_DEPTH_CHECK_INTERVAL_MS ) {
                ...
                if( TiUtils.isWebMode() ) {
                    ...
                    watchdogEntryDepthTimerId = watchdogEntryDepthScheduleForTi();
                }
            }
        }
        ...
        if( initialEntry ) {
            ...
            if( GWT.isScript() && watchdogEntryDepthTimerId != -1 ) {
                if( TiUtils.isWebMode() ) {
                    ...
                    watchdogEntryDepthCancelForTi( watchdogEntryDepthTimerId );
                }
    ...
    private static native void watchdogEntryDepthCancelForTi( int timerId ) /*-{
    ...
    private static native int watchdogEntryDepthScheduleForTi() /*-{
		return setTimeout(
				@com.google.gwt.core.client.impl.Impl::watchdogEntryDepthRun(),
				10);
    }-*/;
