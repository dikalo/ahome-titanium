...
import com.ait.toolkit.titanium.mobile.client.core.Timer;
...
public class Request {
	...
	public boolean isPending() {
		 ...
		 * XmlHttpRequest.OPEN. That is why we include open although it is
		 * nottechnically true since open implies that the request has not been
		 * sent.
		 */
		switch (readyState) {
	...
	public void fireOnResponseReceived(RequestCallback callback) {
		 ...
		 * JavaScript XmlHttpRequest object so we manually null out our
