...
public class ActivityIndicator extends View implements HasFont, HasColor,
    ...
    public ActivityIndicator() {
        jsObj = UI.createActivityIndicator( "", new ArrayList<String>() );
    }

    public ActivityIndicator( String id ) {
        jsObj = UI.createActivityIndicator( id, new ArrayList<String>() );
    }

    public ActivityIndicator( String id, List<String> classes ) {
        jsObj = UI.createActivityIndicator( id, classes );
    }
