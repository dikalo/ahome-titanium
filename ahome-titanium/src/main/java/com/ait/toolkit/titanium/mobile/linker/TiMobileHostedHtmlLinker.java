...
public class TiMobileHostedHtmlLinker extends AbstractLinker {

    protected DefaultTextOutput out;

    @Override
    public String getDescription() {
        return "Titanium4j Linker that generates a hosted html files that does not caches the nocache.js file";
    }
    ...
    public ArtifactSet link( TreeLogger logger, LinkerContext context,
        ...
        toReturn.add( emitString( logger, out.toString(), context.getModuleName() + ".html" ) );
