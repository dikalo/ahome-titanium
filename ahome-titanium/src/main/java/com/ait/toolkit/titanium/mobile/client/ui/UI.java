...
public class UI extends TiModule {
    ...
    public void drawGrid( View view, int gridSpacing, String color ) {
        ...
        double numHorizontal = Math.ceil( Platform.get().getDisplayCaps()
            .getPlatformHeight()
                / gridSpacing );
        double numVertical = Math.ceil( Platform.get().getDisplayCaps()
            .getPlatformWidth()
                / gridSpacing );
    ...
    public void setSizePropertyAsDouble( JavaScriptObject peer, String property,
            double value ) {
    ...
    public void setSizePropertyAsString( JavaScriptObject peer, String property,
            String value ) {
        if( Platform.get().isAndroid() ) {
            ...
            if( value != null
                    && value.length() > 2
                    && !value.substring( value.length() - 2 ).matches(
                        "/^[0-9]+$/" ) ) {
                JsoHelper.setAttribute( peer, property, value );
                                                             ...
                                                             // on
                                                             // a null object
                JsoHelper.setAttribute( peer, property,
                    value + Unit.DP.getValue() );
            } else {
                JsoHelper.setAttribute( peer, property, value );
            }
    ...
    private void setSizeProperty( JavaScriptObject peer, String property,
            String value ) {
        if( Platform.get().isAndroid() ) {
            JsoHelper.setAttribute( peer, property, value + Unit.DP.getValue() );
        } else {
    ...
    static native JavaScriptObject create2DMatrix( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.2DMatrix', id, classes)
		return obj || Titanium.UI.create2DMatrix();
    }-*/;

    static native JavaScriptObject createActivityIndicator( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.ActivityIndicator', id, classes)
		return obj || Titanium.UI.createActivityIndicator();
    }-*/;

    static native JavaScriptObject createAlertDialog( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.AlertDialog', id, classes)
		return obj || Titanium.UI.createAlertDialog();
    }-*/;

    static native JavaScriptObject createAlertDialog( String elId, List<String> elClasses, JsArrayString buttons )/*-{
		if (@com.ait.toolkit.titanium.mobile.client.ui.UI::isAlloy()()) {
			var cls = @com.ait.toolkit.titanium.mobile.client.ui.UI::_createClassList(Ljava/util/List;)(elClasses);
			return $.UI.create('Titanium.UI.AlertDialog', {
				'id' : elId,
				'class' : cls,
				buttonNames : buttons
			})
    ...
    static native JavaScriptObject createAnimation( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.Animation', id, classes)
		return obj || Titanium.UI.createAnimation();
    }-*/;

    static native JavaScriptObject createButton( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.Button', id, classes)
		return obj || Titanium.UI.createButton();
    }-*/;
    ...
    static native JavaScriptObject create3DMatrix( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.3DMatrix', id, classes)
		return obj || Titanium.UI.create3DMatrix();
    }-*/;

    static native JavaScriptObject createDashboardItem( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.DashboardItem', id, classes)
		return obj || Titanium.UI.createDashboardItem();
    }-*/;

    static native JavaScriptObject createDashboardView( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.DashboardView', id, classes)
		return obj || Titanium.UI.createDashboardView();
    }-*/;

    static native JavaScriptObject createDashboardView( String elId, List<String> elClasses, int col, int row )/*-{
		if (@com.ait.toolkit.titanium.mobile.client.ui.UI::isAlloy()()) {
			var cls = @com.ait.toolkit.titanium.mobile.client.ui.UI::_createClassList(Ljava/util/List;)(elClasses);
			return $.UI.create('Titanium.UI.DashboardView', {
				'id' : elId,
				'class' : cls,
				columnCount : col,
				rowCount : row
    ...
    static native JavaScriptObject createEmailDialog( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.EmailDialog', id, classes)
		return obj || Titanium.UI.createEmailDialog();
    }-*/;

    static native JavaScriptObject createImageView( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.ImageView', id, classes)
		return obj || Titanium.UI.createImageView();
    }-*/;

    static native JavaScriptObject createMaskedImage( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.MaskedImage', id, classes)
		return obj || Titanium.UI.createMaskedImage();
    }-*/;

    static native JavaScriptObject createNotification( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.Notification', id, classes)
		return obj || Titanium.UI.createNotification();
    }-*/;

    static native JavaScriptObject createLabel( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.Label', id, classes)
		return obj || Titanium.UI.createLabel();
    }-*/;

    static native JavaScriptObject createOptionDialog( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.OptionDialog', id, classes)
		return obj || Titanium.UI.createOptionDialog();
    }-*/;

    static native JavaScriptObject createRefreshControl( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.RefreshControl', id, classes)
    ...
    static native JavaScriptObject createPicker( String elId, List<String> elClasses, boolean spinner )/*-{
		if (@com.ait.toolkit.titanium.mobile.client.ui.UI::isAlloy()()) {
			var cls = @com.ait.toolkit.titanium.mobile.client.ui.UI::_createClassList(Ljava/util/List;)(elClasses);
			return $.UI.create('Titanium.UI.Picker', {
				'id' : elId,
				'class' : cls,
				useSpinner : spinner
			})
    ...
    static native JavaScriptObject createPickerColumn( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.PickerColumn', id, classes)
		return obj || Titanium.UI.createPickerColumn();
    }-*/;

    static native JavaScriptObject createPickerRow( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.PickerRow', id, classes)
		return obj || Titanium.UI.createPickerRow();
    }-*/;

    static native JavaScriptObject createProgressBar( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.ProgressBar', id, classes)
		return obj || Titanium.UI.createProgressBar();
    }-*/;

    static native JavaScriptObject createScrollableView( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.ScrollableView', id, classes)
		return obj || Titanium.UI.createScrollableView();
    }-*/;

    static native JavaScriptObject createScrollView( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.ScrollView', id, classes)
		return obj || Titanium.UI.createScrollView();
    }-*/;

    static native JavaScriptObject createSearchBar( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.SearchBar', id, classes)
		return obj || Titanium.UI.createSearchBar();
    }-*/;

    static native JavaScriptObject createSlider( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.Slider', id, classes)
		return obj || Titanium.UI.createSlider();
    }-*/;

    static native JavaScriptObject createSwitch( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.Switch', id, classes)
		return obj || Titanium.UI.createSwitch();
    }-*/;

    static native JavaScriptObject createTab( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.Tab', id, classes)
		return obj || Titanium.UI.createTab();
    }-*/;

    static native JavaScriptObject createTabGroup( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.TabGroup', id, classes)
		return obj || Titanium.UI.createTabGroup();
    }-*/;

    static native JavaScriptObject createTableView( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.TableView', id, classes)
		return obj || Titanium.UI.createTableView();
    }-*/;

    static native JavaScriptObject createTableViewRow( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.TableViewRow', id, classes)
		return obj || Titanium.UI.createTableViewRow();
    }-*/;

    static native JavaScriptObject createTableViewSection( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.TableViewSection', id, classes)
		return obj || Titanium.UI.createTableViewSection();
    }-*/;

    static native JavaScriptObject createTextArea( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.TextArea', id, classes)
		return obj || Titanium.UI.createTextArea();
    }-*/;

    static native JavaScriptObject createTextField( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.TextField', id, classes)
		return obj || Titanium.UI.createTextField();
    }-*/;

    static native JavaScriptObject createToolbar( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.Toolbar', id, classes)
		return obj || Titanium.UI.createToolbar();
    }-*/;

    static native JavaScriptObject createView( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.View', id, classes)
		return obj || Titanium.UI.createView();
    }-*/;

    static native JavaScriptObject createWebView( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.WebView', id, classes)
		return obj || Titanium.UI.createWebView();
    }-*/;

    static native JavaScriptObject createWindow( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.Window', id, classes)
		return obj || Titanium.UI.createWindow();
    }-*/;

    static native JavaScriptObject createButtonBar( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.ButtonBar', id, classes)
		return obj || Titanium.UI.createButtonBar();
    }-*/;

    static native JavaScriptObject createListItem( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.ListItem', id, classes)
		return obj || Titanium.UI.createListItem();
    }-*/;

    static native JavaScriptObject createListView( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.ListView', id, classes)
		return obj || Titanium.UI.createListView();
    }-*/;

    static native JavaScriptObject createListSection( String id, List<String> classes ) /*-{
		var obj = @com.ait.toolkit.titanium.mobile.client.ui.UI::createIfPossible(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)('Titanium.UI.ListSection', id, classes)
		return obj || Titanium.UI.createListSection();
    }-*/;
    ...
    static JavaScriptObject _createClassList( List<String> classes ) {
        JsArrayString toReturn = JsArray.createArray().cast();
        for( String classElement : classes ) {
            toReturn.push( classElement + " " );
        }
        return toReturn;
    }

    static native boolean isAlloy()/*-{
    ...
    private static native JavaScriptObject createIfPossible( String el, String elId, List<String> elClasses )/*-{
		if (@com.ait.toolkit.titanium.mobile.client.ui.UI::isAlloy()()) {
			var cls = @com.ait.toolkit.titanium.mobile.client.ui.UI::_createClassList(Ljava/util/List;)(elClasses);
			return $.UI.create(el, {
				'id' : elId,
