...
public class IOS extends TiModule {
    ...
    public static native final int BLEND_MODE_CLEAR() /*-{
		return Titanium.UI.iOS.BLEND_MODE_CLEAR
				? Titanium.UI.iOS.BLEND_MODE_CLEAR
				: 0;
    }-*/;
    ...
    public static native final int BLEND_MODE_LIGHTEN() /*-{
		return Titanium.UI.iOS.BLEND_MODE_LIGHTEN
				? Titanium.UI.iOS.BLEND_MODE_LIGHTEN
				: 0;
    }-*/;
    ...
    public static native final int BLEND_MODE_MULTIPLY() /*-{
		return Titanium.UI.iOS.BLEND_MODE_MULTIPLY
				? Titanium.UI.iOS.BLEND_MODE_MULTIPLY
				: 0;
    }-*/;
    ...
    public static native final int BLEND_MODE_OVERLAY() /*-{
		return Titanium.UI.iOS.BLEND_MODE_OVERLAY
				? Titanium.UI.iOS.BLEND_MODE_OVERLAY
				: 0;
    }-*/;
    ...
    public static native final int BLEND_MODE_SCREEN() /*-{
		return Titanium.UI.iOS.BLEND_MODE_SCREEN
				? Titanium.UI.iOS.BLEND_MODE_SCREEN
				: 0;
    }-*/;
