...
public class TableViewSection extends View {
    ...
    public TableViewSection( String id ) {
        this( id, new ArrayList<String>() );
    }

    public TableViewSection( String id, List<String> classes ) {
        jsObj = UI.createTableViewSection( id, classes );
    }
    ...
    public void createPeer() {
        jsObj = UI.createTableViewSection( "", new ArrayList<String>() );
    }
