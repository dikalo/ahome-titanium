...
public abstract class EventListener<T extends Event> {
    ...
    private static native JavaScriptObject createPeer( EventListener<?> listener ) /*-{
		var callback = function(e) {
			...
			listener.@com.ait.toolkit.titanium.mobile.client.core.events.EventListener::fireOnEvent(Lcom/ait/toolkit/titanium/mobile/client/core/events/Event;)(eventObject);
		};
