...
public class TableView extends View {
    ...
    public TableView( String id, List<String> classes ) {
        jsObj = UI.createTableView( id, classes );
        this.rows = new ArrayList<TableViewRow>();
        this.sections = new ArrayList<TableViewSection>();
    }
    ...
    public TableView( String id, List<String> classes, List<? extends TableViewBaseModel> data ) {
        this( id, classes );
    ...
    public void createPeer() {
        jsObj = UI.createTableView( "", new ArrayList<String>() );
    }
