...
public class EmailDialog extends EventDispatcher implements HasAttachment,
    ...
    public EmailDialog( String id ) {
        jsObj = UI.createEmailDialog( id, new ArrayList<String>() );
    }

    public EmailDialog( String id, List<String> classes ) {
        jsObj = UI.createEmailDialog( id, classes );
    }
    ...
    private void createPeer() {
        jsObj = UI.createEmailDialog( "", new ArrayList<String>() );
    }
